...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mdit-py-plugins-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11449&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mdit-py-plugins-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `mdit-py-plugins` available on your platform with:
